...
const fNetwork = ref('tcp'); const fSecurity = ref('reality'); const fUUID = ref(''); const fPassword = ref(''); const fVMessSecurity = ref('auto')
...
<template v-if="showSSFields"><select v-model="fMethod" class="suigo-input"><option>aes-128-gcm</option><option>aes-192-gcm</option><option>aes-256-gcm</option><option>chacha20-ietf-poly1305</option><option>xchacha20-ietf-poly1305</option><option>2022-blake3-aes-128-gcm</option><option>2022-blake3-aes-256-gcm</option><option>2022-blake3-chacha20-poly1305</option></select><input v-model="fPassword" class="suigo-input" placeholder="password"/></template>
